 ...
 *
 * Defines styling for A2UI components to match React Spectrum V2 aesthetics.
 * Uses the v0_8 theme specification from @a2ui/lit.
 */
...
/**
 * A2UI Theme matching React Spectrum V2 design system
 */
