...
A Google ADK agent that finds restaurants and generates A2UI responses.
"""
...
from a2ui_prompt_builder import (
    A2UI_SCHEMA,
...
2.  **For booking a table (when you receive a query like 'USER_WANTS_TO_BOOK...'):**
    a. You MUST use the booking form UI example to generate the UI, populating the data with the details from the user's query.
...
3.  **For confirming a booking (when you receive a query like 'User submitted a booking...'):**
    ...
    b. You MUST use the confirmation UI example to generate the confirmation UI with the final booking details.

4.  **For showing restaurant details:**
    a. Call the `get_restaurant_details` tool to get detailed information.
    b. Display the details using a Card component.
"""
